...
\begin{minipage}[t]{95.5mm}
	...
	\vspace{-0.25mm}\setlength{\partopsep}{-1.2mm}{\small%
...
\begin{minipage}[t]{95.5mm}
	...
	\vspace{3mm}
	\textbf{\textsf{\color{grey}interactive art}} -- Technical manager of the \emph{beta\_space} exhibition at the Powerhouse Museum (2007-10), exhibited own work in 2008. Lead technician at New Media Curation, helping develop and install new media artworks (2007-11).
	
	\vspace{3mm}
	\textbf{\textsf{\color{grey}hackathons}} -- Global Game Jam (2011, 2012); Android Dev Camp (2012); Crisis Camp (2010); Amped (2010).
