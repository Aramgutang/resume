...
\begin{minipage}[t]{45mm}
	{\small%
		...
		\vspace{-1mm}\begin{spacing}{0.9}Director of the Interaction Consortium and direct supervisor.\end{spacing}%
		\vspace{-5mm}%
	}%
\end{minipage}%
\hspace{5mm}%
...
\begin{minipage}[t]{45mm}
	{\small%
		...
		\vspace{-1mm}\begin{spacing}{0.9}Colleague at the Interaction Consortium and Django core developer.\end{spacing}%
		\vspace{-5mm}%
	}%
\end{minipage}%
\hspace{5mm}%
\begin{minipage}[t]{45mm}
	{\small%
		...
		\vspace{-1mm}\begin{spacing}{0.9}Director of New Media Curation and close personal friend.\end{spacing}%
	\vspace{-5mm}%
	}%
\end{minipage}%
\end{spacing}%
